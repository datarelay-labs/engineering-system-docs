...
<CardGroup cols={2}>
  ...
  <Card title="Cursor persist / tmux + Phone SSH" icon="terminal" href="/mobile-remote-workflow">
    Let ChatGPT start Cursor on the development server, then reconnect with `agent persist` or ordinary tmux when appropriate.
  </Card>

...
The intended 1.5.1 entrypoint remains simply:

~~~text
Apply https://github.com/datarelay-labs/engineering-system to this project.
~~~

The agent should not blindly copy files. It should follow the canonical adoption standard:
...
Managed 1.5.1 adoption pins both the Engineering System version and an immutable canonical baseline SHA. It also records shared/native CI ownership, merge-gate enforcement state, and explicit operations posture so agents do not infer those facts from workflow presence alone.

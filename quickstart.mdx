...
The intended 1.5 entrypoint remains simply:
...
Managed 1.5 adoption pins both the Engineering System version and an immutable canonical baseline SHA. It also records shared/native CI ownership, merge-gate enforcement state, and explicit operations posture so agents do not infer those facts from workflow presence alone.

...
With Engineering System 1.5, the user-facing request can be:
...
Engineering System 1.5 adopted repositories record enough identity to prove exactly which canonical standard and which project-native gates are in force:
~~~yaml
engineering_system:
  version: "1.5.0"
  mode: adopted
